...
class Blockchain(object):
    ...
    def register_nodes(self, address):
        ...
        :param address: <str> Adress of node. Eg. 'http://197.168.0.5:5000'
        :return: None
        """
    ...
    def new_transaction(self, sender, recipient, amount):
        """
        Creates a new transaction to go into de next mined block
    ...
    def proof_of_wrok(self, last_proof):
        """
...
def mine():
    ...
    proof = blockchain.proof_of_wrok(last_proof)
...
def new_transaction():
    ...
    response = {'message': f'Tramsaction will be added to Block {index}'}
